...
import 'presentation/background/utils/background_layers.dart';
import 'presentation/home/home_page.dart';
import 'presentation/layout/background_layer_layout.dart';
  ...
  void didChangeDependencies() {
    if (_isInit) {
      for (BackgroundLayerType layerType in BackgroundLayers.types) {
        precacheImage(
          Image.asset('assets/images/background/${layerType.name}.png', package: 'game_dashtronaut',).image,
          context,
        );
      }
      ...
      for (int size in Puzzle.supportedPuzzleSizes) {
        precacheImage(
          Image.asset('assets/images/puzzle-solved/solved-${size}x$size.png', package: 'game_dashtronaut',)
              .image,
          context,
        );
      }
